// File      : Main.java          28/02/2024
// Penulis   : Zikry Alfahri Akram
// Deskripsi : Class yang berisi Main dari Student, Lecture, dan Course
...
public class Main {
    public static void main(String[] args) {
      ...
      Lecture budi = new Lecture("Budi", 40, "Banyumanik", 177026);
      ...
      Course paik6401 = new Course("PAIK6402", "Pemrograman Berorientasi Objek", adit);
