...
public class Senjata {
    ...
    // Prosedur ini menampilkan pesan 'Bayonet Terpasang' dengan mengatur nilai 'menusuk' adalah True
    public void pasangBayonet(){
        setMenusuk(true);
        System.out.println("Bayonet Terpasang");
    }
    // Fungsi ini menampilkan pesan apakah senjata berhasil menusuk atau tidak
